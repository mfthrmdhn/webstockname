...
Read and follow `/Users/miftahramadhan/Projects/webstockname/.claude/get-shit-done/workflows/transition.md`.
...
```bash
node "/Users/miftahramadhan/Projects/webstockname/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
