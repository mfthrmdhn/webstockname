...
- **Global scope**: `/Users/miftahramadhan/Projects/webstockname/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/miftahramadhan/Projects/webstockname/.claude/notes/`)
...
2. Glob `/Users/miftahramadhan/Projects/webstockname/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/miftahramadhan/Projects/webstockname/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/miftahramadhan/Projects/webstockname/.claude/notes/` — works in any directory
