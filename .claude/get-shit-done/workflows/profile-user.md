...
```bash
cp "/Users/miftahramadhan/Projects/webstockname/.claude/get-shit-done/USER-PROFILE.md" "/Users/miftahramadhan/Projects/webstockname/.claude/USER-PROFILE.backup.md"
```
...
```bash
BACKUP_PATH="/Users/miftahramadhan/Projects/webstockname/.claude/USER-PROFILE.backup.md"
```
